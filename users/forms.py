...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta:
        ...
        help_texts = {
            ...
            'department': 'Department name (text field, optional)',
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Remove department_fk from form fields (not shown on signup page)
        if 'department_fk' in self.fields:
            del self.fields['department_fk']
...
class FacultyCreationForm(CustomUserCreationForm):
    ...
    class Meta(CustomUserCreationForm.Meta):
        fields = ('username', 'email', 'first_name', 'last_name', 'department', 'department_fk', 'employee_id', 'designation', 'phone_number')
